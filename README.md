...
Actuator interface for old odrive v3.6 bldc foc controller
...
If you are familiar with ROS 2, here are the quick-and-dirty build instructions.
  ...
  git clone git@github.com:odrive_v3_hardware/odrive_v3_hardware.git src/odrive_v3_hardware
  vcs import src --input src/odrive_v3_hardware/odrive_v3_hardware.jazzy.repos
  vcs import src --input src/odrive_v3_hardware/odrive_v3_hardware.jazzy.upstream.repos
